...
const SignInComponent = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-tl from-yellow-400 to-yellow-900 w-full py-16 px-4">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-secondary shadow rounded lg:w-1/4  md:w-1/3 w-full p-10 mt-16">
                    ...
                    <div>
                        ...
                        <input onChange={(e) => setUsername(e.target.value)} value={username} aria-label="enter username" role="input" type="text" className={error ? "bg-third rounded outline-none text-xs font-medium leading-none text-gray-200 py-3 w-full pl-3 mt-2 border border-red-500" : "bg-third rounded outline-none text-xs font-medium leading-none text-gray-200 py-3 w-full pl-3 mt-2"} />
                    </div>
                    <div className="mt-6  w-full">
                        <label className="text-sm font-medium leading-none text-gray-200">Password</label>
                        <div className="relative flex items-center justify-center">
                            <input onChange={(e) => setPassword(e.target.value)} value={password} aria-label="enter Password" role="input" type={showPassowrd ? "text" : "password"} className={error ? "bg-third rounded outline-none text-xs font-medium leading-none text-gray-200 py-3 w-full pl-3 mt-2 border border-red-500" : "bg-third rounded outline-none text-xs font-medium leading-none text-gray-200 py-3 w-full pl-3 mt-2"} />
                    ...
                    <div onClick={handleLogin} className="mt-8 items-center justify-center flex cursor-pointer">
                        <button disabled={isFetching} className="relative px-10 py-2 font-medium text-white group">
